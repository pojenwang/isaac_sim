...
def main():
    ...
    usd_path = os.path.join(script_dir, "..", "maps", "gale_crater", "gale_crater_gediz_vallis_channel.usdc")
    ...
    add_usd_to_stage(curiosity_path, root_prim_path, x=-169.42155, y=794.2005, z=-331.7026, roll=0.0, pitch=0.0, yaw=0.0)
